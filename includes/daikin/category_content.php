<?php
$categoryJson = file_get_contents("../../category.json");
$categoryJsonDecode = json_decode($categoryJson, true);
$products = $categoryJsonDecode['products'];
$product = false;
...
?>
        <div class="product-img">
            <img src="<?= GLOBAL_URL; ?>/build/img/category/<?= $product['image']; ?>" alt="">
        </div>
