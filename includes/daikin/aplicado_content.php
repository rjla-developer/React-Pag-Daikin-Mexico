<?php
$aplicadoJson = file_get_contents("../../aplicado.json");
$aplicadoJsonDecode = json_decode($aplicadoJson, true);
$products = $aplicadoJsonDecode['products'];
$product = false;
...
?>
        <div class="product-img">
            <img src="<?= GLOBAL_URL; ?>/build/img/aplicado/<?= $product['image']; ?>" alt="">
        </div>
