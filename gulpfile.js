...
function bootstrapIcons() {
    return src(paths.bootstrapIcons)
        .pipe(dest('./build/plugins/bootstrap-icons/'));
}
...
exports.default = parallel(css, javascript, bootstrap, bootstrapIcons, slick, fonts, jquery, imagenes, vrvimg, aplimg, resimg, fourimg, hdimg, versionWebp, watchArchivos);