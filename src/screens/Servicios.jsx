...
function Servicios() {
  ...
  return (
    <Container fluid>
      ...
      <Container>
        <Row className="mb-4 mb-lg-0">
          <Col xs={12} lg={6} className="p-5">
            {imageLoaded && (
              <div className="spinner-container d-flex align-items-center justify-content-center my-5 py-5">
      ...
      <Row className="bg-blue py-5 text-white">
      ...
      <Container>
        <Row className="py-5">
          <h3 className="text-center txt-blue mb-5 text-uppercase">Oficinas</h3>
          ...
          <Col className="mb-3 mx-0" xs={12} md={6} lg={3}>
            <div className="bg-gray p-4">
              <h5 className="txt-blue">Centro de Entrenamiento Daikin</h5>
              <p>
                <i className="bi bi-telephone-fill txt-blue me-2"></i>(+52) 55
                5147 0148
              </p>
